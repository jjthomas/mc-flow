...
set inter_tile_margin_v [expr 20 * max($vert_pitch, $horiz_pitch)]
set inter_tile_margin_h [expr 20 * max($vert_pitch, $horiz_pitch)]
...
set tile_no 0
# TODO guarantee that this iteration is in order from core0 ... n
